...
export default class S3Service {
	 ...
	 */
	public async uploadEntityImages(entityType: EEntityType, entityId: string, processedFiles: Map<ImageProcessingResultKey, Buffer>, originalMimeType: string): Promise<UploadResult> {
	...
	private createUploader(entityType: EEntityType) {
		return (entityId: string, processedFiles: Map<EVariantType, Buffer>, originalMimeType: string) => this.uploadEntityImages(entityType, entityId, processedFiles, originalMimeType);
	}
